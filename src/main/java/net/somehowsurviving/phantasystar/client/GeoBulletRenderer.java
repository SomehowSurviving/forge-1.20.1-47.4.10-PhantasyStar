...
public class GeoBulletRenderer extends GeoEntityRenderer<BulletEntity> {
    public GeoBulletRenderer(EntityRendererProvider.Context ctx) {
        super(ctx, new GeoBulletEntityModel());
    ...
    @Override
    public RenderType getRenderType(BulletEntity animatable,
